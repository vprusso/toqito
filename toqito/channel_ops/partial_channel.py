...
def partial_channel(
    ...
    >>> partial_channel(rho, depolarizing(2, param_p=0.1))
    array([[ 0.299635+0.j      , -0.0198  -0.01971j , -0.06681 -0.000205j,
            -0.0153  -0.06246j ],
           [-0.0198  +0.01971j ,  0.111265+0.j      , -0.06975 +0.04428j ,
            -0.06159 +0.050105j],
           [-0.06681 +0.000205j, -0.06975 -0.04428j ,  0.151945+0.j      ,
             0.05418 +0.00558j ],
           [-0.0153  +0.06246j , -0.06159 -0.050105j,  0.05418 -0.00558j ,
             0.437155+0.j      ]])
    ...
    ...                 [-0.0671+0.0030*1j, -0.0775-0.0492*1j, 0.1361, 0.0602 + 0.0062*1j],
    ...                 [-0.0170+0.0694*1j, -0.0613-0.0529*1j, 0.0602-0.0062*1j, 0.4530]])
    >>> partial_channel(rho, depolarizing(2, param_p=0.1), 1)
    array([[ 0.3014 +0.j      , -0.01789-0.020495j, -0.06039-0.0027j  ,
            -0.0153 -0.06246j ],
           [-0.01789+0.020495j,  0.11841+0.j      , -0.06975+0.04428j ,
            -0.05517+0.04761j ],
           [-0.06039+0.0027j  , -0.06975-0.04428j ,  0.1448 +0.j      ,
             0.05609+0.004795j],
           [-0.0153 +0.06246j , -0.05517-0.04761j ,  0.05609-0.004795j,
             0.43539+0.j      ]])
