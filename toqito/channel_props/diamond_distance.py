...
def diamond_distance(choi_1: np.ndarray, choi_2: np.ndarray) -> float:
    ...
    :py:func:`~toqito.channel_props.completely_bounded_trace_norm.completely_bounded_trace_norm`, in that it returns
    ...
    .. jupyter-execute::
        ...
        from toqito.channel_props import diamond_distance
    ...
    """
    from toqito.channel_props import completely_bounded_trace_norm
