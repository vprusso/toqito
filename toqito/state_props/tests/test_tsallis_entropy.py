"""Tests for tsallis_entropy (numeric / constant only)."""
...
def test_tsallis_entropy_mat_x_wrong_type() -> None:
...
def test_tsallis_entropy_mat_x_not_square() -> None:
...
def test_tsallis_entropy_t_out_of_range() -> None:
...
def test_tsallis_entropy_constant_no_value() -> None:
...
def test_tsallis_entropy_rejects_nonconstant_variable() -> None:
...
def test_tsallis_entropy_rejects_nonconstant_quadratic() -> None:
