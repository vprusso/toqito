...
@pytest.mark.parametrize("rho, level, dim, ppt, expected_result", [
    # Check whether 2-qubit state has a symmetric extension.
    (np.array([[1, 0, 0, -1], [0, 1, 1 / 2, 0], [0, 1 / 2, 1, 0], [-1, 0, 0, 1]]), 2, None, True, True),
...
@pytest.mark.parametrize("rho, level, dim, ppt", [
    # Check whether 2-qubit state has a symmetric extension.
