...
def diamond_norm(choi_1: np.ndarray, choi_2: np.ndarray) -> float:
    ...
    Examples
    ========
    Consider the depolarizing and identity channels in a 2-dimensional space.
    The depolarizing channel parameter is set to 0.2:
    ...
    Similarly, we can compute the diamond norm between the dephasing channel (with parameter 0.3)
