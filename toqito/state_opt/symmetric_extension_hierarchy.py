...
def symmetric_extension_hierarchy(
    ...
    It is known from :cite:`Cosentino_2015_QuantumState` that distinguishing three Bell states along with a
    resource state :math:`|\tau_{\epsilon}\rangle` via separable measurements has the following closed form
