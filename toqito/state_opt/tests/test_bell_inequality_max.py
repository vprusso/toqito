...
import importlib  # For reliable module loading
...
# Load the module object to avoid shadowing by the function
bim = importlib.import_module("toqito.state_opt.bell_inequality_max")
