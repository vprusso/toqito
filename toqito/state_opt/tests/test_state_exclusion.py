...
states_min_error = [
    ...
    ([vector_to_density_matrix(bell(0)), vector_to_density_matrix(bell(1))], None, 0, {"cvxopt_kktsolver": "ldl"}),
    ([vector_to_density_matrix(bell(0)), vector_to_density_matrix(bell(1))], [1 / 2, 1 / 2], 0, {"cvxopt_kktsolver": "ldl"}),
...
states_unambiguous = [
    ...
    ([bell(0), bell(1), bell(2), bell(3)], None, 0, {}),
    ([bell(0), bell(1), bell(2), bell(3)], [1 / 4, 1 / 4, 1 / 4, 1 / 4], 0, {}),
    ([vector_to_density_matrix(bell(0)), vector_to_density_matrix(bell(1))], None, 0, {}),
    ([vector_to_density_matrix(bell(0)), vector_to_density_matrix(bell(1))], [1 / 2, 1 / 2], 0, {}),
