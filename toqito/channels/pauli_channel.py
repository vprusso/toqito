...
def pauli_channel(
    ...
    length strictly equal to :math:`q`, and :math:`p_i` is the corresponding probability of that operator where,
    :math:`q` is the number of qubits. For example, when :math:`q = 2`;
