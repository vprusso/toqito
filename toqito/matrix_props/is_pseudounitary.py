...
def is_pseudounitary(mat: np.ndarray, signature_tup: tuple):
    """
    Checks if a matrix is pseudo-unitary with respect to a given signature.
    ...
    Returns:
        bool: True if the matrix is pseudo-unitary, False otherwise.
    """
    ...
    is_pseudo = np.allclose(mat.conj().T @ metric @ mat, metric)
    return is_pseudo