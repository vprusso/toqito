...
>>>>>>> d9254eb7 (Added citations, made the examples executable, fixed inline math mode inconsistencies, fixed backticks inconsistencies, fixed typehints, updated regex)
