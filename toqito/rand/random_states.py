"""Module for generating random quantum states using Qiskit.

Provides functionality to generate random quantum states with Qiskit's random_statevector function.
Includes a function `random_states` to create a specified number of quantum states,
each of a specified dimension.
