...
.. py:module:: state_metrics.helstrom_holevo
...
.. autoapisummary::
   ...
   state_metrics.helstrom_holevo.helstrom_holevo
...
.. py:function:: helstrom_holevo(rho, sigma)
   ...
   Compute the Helstrom-Holevo distance between density matrices :cite:`WikiHolevo`.
