matrix_props.is_linearly_independent
====================================

.. py:module:: matrix_props.is_linearly_independent
...
.. autoapisummary::
   ...
   matrix_props.is_linearly_independent.is_linearly_independent


Module Contents
---------------

.. py:function:: is_linearly_independent(vectors)

   Check if set of vectors are linearly independent :cite:`WikiLinearIndependence`.
