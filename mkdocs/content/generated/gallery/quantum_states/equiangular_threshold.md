...
<!--
 ...
 "content/examples/quantum_states/equiangular_threshold.py"
...
<!-- GENERATED FROM PYTHON SOURCE LINES 14-66 -->
...
![Antidistinguishability Threshold for Equiangular States](./images/mkd_glr_equiangular_threshold_001.png){: .mkd-glr-single-img srcset="../images/mkd_glr_equiangular_threshold_001.png"}

Out:
{: .mkd-glr-script-out }

```{.shell .mkd-glr-script-out-disp }
/home/manasa/Desktop/toqito/mkdocs/content/examples/quantum_states/equiangular_threshold.py:166: UserWarning: FigureCanvasAgg is non-interactive, and thus cannot be shown
  plt.show()
...
**Total running time of the script:** ( 0 minutes  15.958 seconds)

<div id="download_links"></div>



[:fontawesome-solid-download: Download Python source code: equiangular_threshold.py](./equiangular_threshold.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: equiangular_threshold.ipynb](./equiangular_threshold.ipynb){ .md-button .center}
