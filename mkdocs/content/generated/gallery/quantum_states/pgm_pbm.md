...
<!--
 ...
 "content/examples/quantum_states/pgm_pbm.py"
...
Analyzing k=3 trine states with uniform probability.
...
![PGM and PBM Performance for 100 Random Ensembles (k=4)](./images/mkd_glr_pgm_pbm_001.png){: .mkd-glr-single-img srcset="../images/mkd_glr_pgm_pbm_001.png"}

Out:
{: .mkd-glr-script-out }

```{.shell .mkd-glr-script-out-disp }
/home/manasa/Desktop/toqito/mkdocs/content/examples/quantum_states/pgm_pbm.py:254: UserWarning: FigureCanvasAgg is non-interactive, and thus cannot be shown
  plt.show()
...
[:fontawesome-solid-download: Download Python source code: pgm_pbm.py](./pgm_pbm.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: pgm_pbm.ipynb](./pgm_pbm.ipynb){ .md-button .center}
