...
<!--
 ...
 "content/examples/02_quantum_states/circulant_states.py"
...
Traceback (most recent call last):
  File "/Users/kawayip/toqito_private_notebook/mkdocs/content/examples/02_quantum_states/circulant_states.py", line 53, in <module>
    from toqito.matrix_ops import vectors_from_gram_matrix
...
[:fontawesome-solid-download: Download Python source code: circulant_states.py](./circulant_states.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: circulant_states.ipynb](./circulant_states.ipynb){ .md-button .center}
