...
<!--
 ...
 "content/examples/02_quantum_states/pbr_theorem.py"
...
Traceback (most recent call last):
  File "/Users/kawayip/toqito_private_notebook/mkdocs/content/examples/02_quantum_states/pbr_theorem.py", line 44, in <module>
    from scipy.stats import norm
...
<!-- GENERATED FROM PYTHON SOURCE LINES 71-130 -->
...
[:fontawesome-solid-download: Download Python source code: pbr_theorem.py](./pbr_theorem.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: pbr_theorem.ipynb](./pbr_theorem.ipynb){ .md-button .center}
