...
<!--
 ...
 "content/examples/02_quantum_states/state_exclusion.py"
...
Traceback (most recent call last):
  File "/Users/kawayip/toqito_private_notebook/mkdocs/content/examples/02_quantum_states/state_exclusion.py", line 98, in <module>
    from toqito.states import trine
...
<!-- GENERATED FROM PYTHON SOURCE LINES 163-196 -->
...
[:fontawesome-solid-download: Download Python source code: state_exclusion.py](./state_exclusion.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: state_exclusion.ipynb](./state_exclusion.ipynb){ .md-button .center}
