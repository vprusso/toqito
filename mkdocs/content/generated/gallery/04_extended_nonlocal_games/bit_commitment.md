...
<!--
 ...
 "content/examples/04_extended_nonlocal_games/bit_commitment.py"
...
Traceback (most recent call last):
  File "/Users/kawayip/toqito_private_notebook/mkdocs/content/examples/04_extended_nonlocal_games/bit_commitment.py", line 85, in <module>
    from toqito.states import basis
...
<!-- GENERATED FROM PYTHON SOURCE LINES 127-163 -->
...
[:fontawesome-solid-download: Download Python source code: bit_commitment.py](./bit_commitment.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: bit_commitment.ipynb](./bit_commitment.ipynb){ .md-button .center}
