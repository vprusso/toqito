...
<!--
 ...
 "content/examples/04_extended_nonlocal_games/enlg_introduction.py"
...
<!-- GENERATED FROM PYTHON SOURCE LINES 27-246 -->
...
[:fontawesome-solid-download: Download Python source code: enlg_introduction.py](./enlg_introduction.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: enlg_introduction.ipynb](./enlg_introduction.ipynb){ .md-button .center}
