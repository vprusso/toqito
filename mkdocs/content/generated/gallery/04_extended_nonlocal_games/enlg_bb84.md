...
<!--
 ...
 "content/examples/04_extended_nonlocal_games/enlg_bb84.py"
...
Traceback (most recent call last):
  File "/Users/kawayip/toqito_private_notebook/mkdocs/content/examples/04_extended_nonlocal_games/enlg_bb84.py", line 52, in <module>
    from toqito.states import basis
...
[:fontawesome-solid-download: Download Python source code: enlg_bb84.py](./enlg_bb84.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: enlg_bb84.ipynb](./enlg_bb84.ipynb){ .md-button .center}
