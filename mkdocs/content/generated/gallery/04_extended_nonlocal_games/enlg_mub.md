...
<!--
 ...
 "content/examples/04_extended_nonlocal_games/enlg_mub.py"
...
<!-- GENERATED FROM PYTHON SOURCE LINES 49-104 -->
...
Traceback (most recent call last):
  File "/Users/kawayip/toqito_private_notebook/mkdocs/content/examples/04_extended_nonlocal_games/enlg_mub.py", line 52, in <module>
    from toqito.states import basis
...
[:fontawesome-solid-download: Download Python source code: enlg_mub.py](./enlg_mub.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: enlg_mub.ipynb](./enlg_mub.ipynb){ .md-button .center}
